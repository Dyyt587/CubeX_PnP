...
FluContentPage{
    ...
    FluMenu{
        ...
        contentItem: Item{
            ...
            onVisibleChanged: {
                if(visible){
                    layer_filter_text.text = root.layerKeyword
            ...
            FluButton{
                ...
                onClicked: {
                    root.layerKeyword = layer_filter_text.text
        ...
        FluSplitLayout {
            ...
            CubexFluTableView{
                ...
                columnSource:[
                    ...
                    {
                        title: table_view.customItem(com_column_filter_layer,{}),
                        dataIndex: 'layer',
                        width:80,
                        minimumWidth:60,
                        maximumWidth:120
